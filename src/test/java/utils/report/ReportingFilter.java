...
public class ReportingFilter implements Filter {
    ...
    public ReportingFilter(ITestContext context) {
        // Temporarily disable Extent logic
        /*
        ExtentTest test = ExtentManager.getTest();
        if (test == null) {
            test = ExtentManager.createTest("AutoGenerated_" + System.currentTimeMillis());
        }
        */
        ...
        if (testName == null || testName.isEmpty()) {
            testName = "UnnamedTest_" + System.currentTimeMillis();
        }

        // Log safely (optional):
        /*
        if (reporter != null) {
            reporter.log("Running: " + testName);
        }
        */
    }
